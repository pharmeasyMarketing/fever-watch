(function () {
  ...
  function onClick(e) {
    ...
    else if (a === "dialInfo") { var di = el.closest(".dialinfo"); if (di) { if (_dialTimer) { clearTimeout(_dialTimer); _dialTimer = null; } _peekEl = null; var op = di.classList.toggle("open"); if (op) positionCaret(di); } }    else if (a === "openMethod") {
